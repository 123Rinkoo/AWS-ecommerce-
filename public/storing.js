window.onload = function () {
    ...
    //     axios.get('http://54.168.102.127:3000/products')
    //         .then(Cdata => showingOnScreen(Cdata.data))
    //         .catch(err => console.log(err));
    let pagenumber = 1;
    axios.get(`http://54.168.102.127:3000/products?paaag=${pagenumber}`)
        .then(res => {
    ...
    axios.get('http://54.168.102.127:3000/cart')
        .then((CartProducts) => {
...
function getproducts(page) {
    axios.get(`http://54.168.102.127:3000/products?paaag=${page}`)
        .then(res => {
            showingOnScreen(res.data.Products);
            ShowingPagination(res.data);
        })
...
function addToCart(productId) {
    axios.post('http://54.168.102.127:3000/cart', { productId: productId })
        .then((response) => {
...
function SavingOrderDetails() {
    axios.post("http://54.168.102.127:3000/create-order")
        .then(res => {
            console.log(res)
